...
sisso_regressor = SISSORegressor(rung=1, opset='(+)(-)(*)(^2)(^3)(^-1)(exp)(sin)(cos)',
                                 desc_dim=3, subs_sis=40,
                                 method='L1L0', L1L0_size4L0=15,
                                 run_dir=None, clean_run_dir=CLEAN_RUN_DIR)
param_grid = {'rung': [0, 1, 2], 'desc_dim': [2, 3, 4]}
grid_search = GridSearchCV(estimator=sisso_regressor, param_grid=param_grid,
                           cv=4, n_jobs=4)
